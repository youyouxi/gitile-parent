...
public class SysUser implements java.io.Serializable {
	...
	/**构造函数**/
	public SysUser() {}
	public SysUser(Long id,String roleId,String username,String password,String salt,Integer failureLoginCount,Date lastLoginTime,Short status,String background,Long fileSize,Date createdTime,Date lastModifiedTime) {
		this.id=id;
		this.roleId=roleId;
	...
	public SysUser setNotNull(Long id,String roleId,String username,String password,String salt,Integer failureLoginCount,Date lastLoginTime,Short status,Long fileSize,Date createdTime,Date lastModifiedTime) {
		this.id=id;
		this.roleId=roleId;
		this.username=username;
		this.password=password;
	...
	private Long fileSize;// 网盘空间大小m（非空） 
