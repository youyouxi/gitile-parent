...
import com.gitile.weixin.bean.pay.PayJsRequest;
import com.gitile.weixin.bean.pay.PayNativeReply;
import com.gitile.weixin.bean.pay.PayNativeRequest;
import com.gitile.weixin.bean.pay.PayPackage;
import com.gitile.weixin.bean.paymch.MchPayNativeReply;
...
public class PayUtil {
	...
	public static String generatePayNativeReplyXML(PayPackage payPackage,
		...
		return XmlUtil.convertToXML(payNativeReply);
	}
